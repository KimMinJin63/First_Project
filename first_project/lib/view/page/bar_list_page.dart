...
class BarListPage extends GetView<DistrictController> {
  const BarListPage({super.key});
  static const route = '/bar';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: const PreferredSize(
          ...
          child: AppBars(title: '특별한 술집', color: AppColor.black),
        ),
        body: Padding(
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<District>>(
                  future:
                      controller.fetchRestaurant(selectedDistrict, '특별한 술집'),
