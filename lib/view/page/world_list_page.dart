...
class WorldListPage extends GetView<DistrictController> {
  const WorldListPage({super.key});
  static const route = '/world';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBars(title: '세계요리', color: AppColor.black, home: () => Get.offAllNamed(MainPage.route)),
        ),
        body: Padding(
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<District>>(
                    future: controller.findRestaurant(selectedDistrict, '세계요리'),
