...
class DessertListPage extends GetView<DistrictController> {
  const DessertListPage({super.key});
  static const route = '/dessert';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBars(title: '디저트/베이커리', color: AppColor.black, home: () => Get.offAllNamed(MainPage.route)),
        ),
        body: Padding(
