...
class FusionListPage extends GetView<DistrictController> {
  const FusionListPage({super.key});
  static const route = '/fusion';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBars(title: '퓨전/뷔페', color: AppColor.black, home: () => Get.offAllNamed(MainPage.route)),
        ),
        body: Padding(
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<District>>(
                    future:
                        controller.findRestaurant(selectedDistrict, '퓨전/뷔페'),
