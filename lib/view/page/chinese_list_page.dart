...
class ChineseListPage extends GetView<DistrictController> {
  const ChineseListPage({super.key});
  static const route = '/chinese';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBars(title: '중식', color: AppColor.black, home: () => Get.offAllNamed(MainPage.route)),
        ),
        body: Padding(
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<District>>(
                  future: controller.findRestaurant(selectedDistrict, '중식'),
