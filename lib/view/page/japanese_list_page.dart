...
class JapaneseListPage extends GetView<DistrictController> {
  const JapaneseListPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBars(title: '일식', color: AppColor.black, home: () => Get.offAllNamed(MainPage.route)),
        ),
        body: Padding(
            ...
            children: [
              ...
              Expanded(
                child: FutureBuilder<List<District>>(
                  future: controller.findRestaurant(selectedDistrict, '일식'),
